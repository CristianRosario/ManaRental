 ...
 * @author crist
 */
public class NewRenting extends javax.swing.JFrame {



    /**
     * Creates new form NewRenting
     */
    public NewRenting() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel5.setText("Mandatory Field *");
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(TxtCusID, javax.swing.GroupLayout.DEFAULT_SIZE, 124, Short.MAX_VALUE)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String now = Month +"/"+ Day +"/"+ Year;
           ...
           int    clientID = Integer.parseInt(TxtCusID.getText());   
        try{
        List<Model.Customer> customer = Connector.Search.FindClient(clientID);
        List<Model.Movies> movie = Connector.Search.FindMovie(movieID);
        
        for(int i =0 ; i>movie.size(); i++)
        {
            
        }
        repository.Add.AddRent1( TxtMovieID.getText(),  TxtCusID.getText() , now, 0 );
        }catch(Exception e){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NewRenting.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
